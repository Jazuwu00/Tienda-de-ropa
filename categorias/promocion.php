...
<body>
    ...
    <div class="container px-4 px-lg-5">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
          ...
          <li class="nav-item"><a class="nav-link active" href="promocion.php">En promocion</a></li>
  ...
  <div class="text-center">
    <h2 class="mt-3">Lista de ropa en promocion</h2>
    <p>Compralos antes que se agoten!</p>
  </div>
  ...
  <section>
    <div class="container ">
      <div class="row align-items-center px-3 ">
        ...
        $consulta = 'SELECT * FROM ropa WHERE promocion = 1';
